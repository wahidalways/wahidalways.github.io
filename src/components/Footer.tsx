...
const Footer = () => {
  return (
    <footer className="band-ink relative overflow-hidden bg-background text-foreground">
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            <a href="#contact" className="group mt-5 block display text-[clamp(2.5rem,5.2vw,5rem)] leading-[0.95]">
              ...
              <span className="whitespace-nowrap">
                <span className="tone-em">conversation</span>
                <ArrowUpRight
                  aria-hidden="true"
      ...
      {/* The name, once more, at the scale of the page. */}
      <div className="shell mt-16 md:mt-24">
        <p
          aria-hidden="true"
          data-split
          className="display select-none whitespace-nowrap text-[28vw] xl:text-[25rem] leading-[0.8] tracking-[-0.06em] pb-[0.14em]"
        >
          <SplitText parts={["Nayem"]} />
          <span className="split-mask">
            <span className="split-word">
              <span className="inline-block w-[0.16em] h-[0.16em] ml-[0.04em] bg-accent" />
            </span>
          </span>
        </p>
      </div>
